...
export function languageSearchModifiers(lang: string): string[] {
  switch (lang) {
    case "hi": return ["hindi songs", "bollywood", "hindi vlog", "हिंदी"];
    case "kn": return ["kannada songs", "sandalwood", "kannada movie scene", "ಕನ್ನಡ"];
    case "ta": return ["tamil songs", "kollywood", "tamil vlog", "தமிழ்"];
    case "te": return ["telugu songs", "tollywood", "telugu vlog", "తెలుగు"];
    case "ml": return ["malayalam songs", "mollywood", "malayalam vlog", "മലയാളം"];
    case "mr": return ["marathi songs", "marathi movie", "मराठी"];
    case "bn": return ["bengali songs", "bangla movie", "বাংলা"];
    case "gu": return ["gujarati songs", "ગુજરાતી"];
    case "pa": return ["punjabi songs", "punjabi vlog", "ਪੰਜਾਬੀ"];
    case "ur": return ["urdu poetry", "pakistani drama", "اردو"];
    case "es": return ["música en español", "reggaeton", "vlog en español"];
    case "pt": return ["música brasileira", "vlog brasil", "sertanejo"];
    case "fr": return ["musique française", "vlog français"];
    case "de": return ["deutsche musik", "vlog deutsch"];
    case "ja": return ["j-pop", "anime music", "日本"];
    case "ko": return ["k-pop", "korean vlog", "한국"];
    case "zh": return ["中文歌曲", "chinese vlog"];
    case "ar": return ["أغاني عربية", "arabic music"];
    case "id": return ["lagu indonesia", "vlog indonesia"];
    case "tr": return ["türkçe müzik", "vlog türkiye"];
    case "ru": return ["русская музыка", "vlog russia"];
    case "en":
    case "global":
    default: return [];
  }
